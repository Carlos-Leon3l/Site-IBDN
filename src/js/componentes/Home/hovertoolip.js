export function hovertoolip() {
    return `
        <!--aqui começa a section com hover tootip-->
<section class="natureza">
    ...
    <div class="nature">
        ...
        <article class="slide">
            <div class="pagina1">
                <div class="logo-par">
                    <img src="src/img/imagens/logo-protetores-da-natureza-white.png" alt="parnatureza" class="logoprotetores">
                </div>
                    <div class="descricao">  
                        ...
                        <a href="https://ibdn.org.br/atitude-limpa/" class="botao-link" target="_blank">Saiba Mais       
                        </a>      
                    </div>      
            </div>
            <div class="pagina2"> 
                <img src="src/img/imagens/atitude-limpa-logo.png" alt="atitude-limpa"  > 
                <div class="descricao2">É uma ação de cidadania praticada por voluntários de todas as idades e classes sociais, que realizam a catação de lixo em ruas, praças, parques e praias, entre outros locais. Durante a atividade uma parte da equipe realiza a distribuição de materiais educativos sobre os impactos causados ao meio ambiente pelos diferentes resíduos descartados.
                    <a href="https://ibdn.org.br/atitude-limpa/" class="botao-link" target="_blank">Saiba Mais</a>
                </div>
            </div>
            <div class="pagina3">
                <img src="src/img/imagens/projeto-profissopes-logo-300x211.png" alt="projetoprofessor" width="200px" height="180px">
                <div class="descricao3">
                    ...
                    <a href="https://ibdn.org.br/ciencias-e-tecnologias-nas-escolas/" class="botao-link" target="_blank">Saiba Mais</a>
                </div>                   
            </div>
            <div class="pagina4">
                <img src="src/img/imagens/JARDINS-DOS-SENTIDOS-LOG.png" alt="jardins">
                    ...
                    <a href="https://ibdn.org.br/jardim-dos-sentidos/" class="botao-link" target="_blank"> Saiba Mais</a>
                </div>
            </div>
        </article>
    </div>
</section>
<!-- aqui termina a section com hover tooltip-->
    `
}